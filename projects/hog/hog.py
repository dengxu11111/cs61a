...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    score0,score1=max(score0,score1),min(score0,score1)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    dice:       A function of zero arguments that simates a dice roll.
    ...
    while max(score0,score1)<goal:
        if player==0:
            nums=strategy0(score0,score1)
            score=take_turn(nums,score1,dice)
            score0+=score
        else:
            nums=strategy1(score1,score0)
            score=take_turn(nums,score0,dice)
            score1+=score
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=6):
    ...
    boolean=is_swap(score+current_score,opponent_score)
    if(boolean):
