...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        if self.place.ant is not None and self.place.ant.block_path:
            return True
        else:
            return False
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while new_place!=None:
            if new_place.bees and new_place!=hive:
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.imposter:
            ...
            while new_place:
                ant=new_place.ant
                if ant and ant not in self.list_ant:
                    ant.damage*=2
                    self.list_ant.append(ant)
                if isinstance(ant,BodyguardAnt) and ant.ant and ant.ant not in self.list_ant:
                    ant.ant.damage*=2
                    self.list_ant.append(ant.ant)
